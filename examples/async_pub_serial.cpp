...
#include <cstdlib>
#include <string>
#include <cstring>//Set the sender's id correclty according to the entityt on which the gateway is installed
#include <chrono>
#include <vector>
...
*/
  ...
  options.c_cflag |= CS8;
	...
	tcflush(fd, TCIFLUSH);
		...
		connOpts.set_ssl(sslopts);//Set the sender's id correclty according to the entityt on which the gateway is installed
